...
public class CategoryController {
	...
	public YokiResult<Category> add(@RequestBody CategoryModel request) {
		return new YokiResult<Category>(HttpStatus.OK, STATUS, categoryService.saveCategory(request, CrudOperation.CREATE));
	}

	@ApiOperation(value = "update category")
	@RequestMapping(value = "update", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE)
	public YokiResult<Category> update(@RequestBody CategoryModel request) {
		return new YokiResult<Category>(HttpStatus.OK, STATUS, categoryService.saveCategory(request, CrudOperation.UPDATE));
	}
	...
	public YokiResult<Category> remove(
		...
		return new YokiResult<Category>(HttpStatus.OK, STATUS, null);
	}
	...
	public List<Dish> getAvailableDishes(@PathVariable("id") Long id) {
	...
	public YokiResult<Category> removeDishFromCategory(@RequestBody CategoryModel request) {
		return new YokiResult<Category>(HttpStatus.OK, STATUS, categoryService.removeDishFromCategory(request));
	}
	...
	public YokiResult<Category> addDishes(@RequestBody CategoryModel request) {
		return new YokiResult<Category>(HttpStatus.OK, STATUS, categoryService.addDishToCategory(request));
	}
	
	@ApiOperation(value="get category by id")
	@RequestMapping(value="get/{id}", method=RequestMethod.POST)
	public YokiResult<Category> get(@PathVariable("id")Long id) {
		return new YokiResult<Category>(HttpStatus.OK, STATUS, categoryService.get(id));
	}
	...
	public YokiResult<Category> deactivate(@PathVariable("id")Long id) {
		return new YokiResult<Category>(HttpStatus.OK, STATUS, categoryService.processActivation(id, false));
	}
	
	@ApiOperation(value="activate category")
	@RequestMapping(value="activate/{id}", method=RequestMethod.GET)
	public YokiResult<Category> activate(@PathVariable("id")Long id) {
		return new YokiResult<Category>(HttpStatus.OK, STATUS, categoryService.processActivation(id, true));
	}
}
