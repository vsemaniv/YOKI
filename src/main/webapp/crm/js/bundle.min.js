...
"use strict";!function(){function e(e){return{restrict:"E",replace:!0,transclude:!0,scope:{placeholder:"@",mask:"@"},require:"ngModel",templateUrl:"html/blocks/edit-field/edit-field.html",link:function(t,i,d,n){t.editMode=!1,t.editModeOn=function(){t.fieldData=n.$viewValue,t.editMode=!0},t.editModeOff=function(){t.fieldData=n.$viewValue,t.editMode=!1},t.editSave=function(){t.fieldData?(n.$setViewValue(t.fieldData),n.$render(),t.editModeOff()):e.error("Поле не повинно бути порожнім!")};var l=i[0].getElementsByClassName("field-data-value"),a=angular.element(l);a.bind("click",function(){t.$apply(function(){t.editModeOn()}),event.preventDefault()}),i.bind("keydown keypress",function(e){13===e.which&&(t.$apply(function(){t.editSave()}),e.preventDefault())}),n.$render=function(){t.fieldData=n.$viewValue},n.$render()}}}angular.module("blocks.edit-field",[]).directive("editField",e),e.$inject=["toastr"]}();
...
"use strict";!function(){function r(){var r={};return r.shapeArrayInRows=function(r,t){for(var n=[],e=0;e<r.length;e+=t)n.push(r.slice(e,e+t));return n},r.searchByKey=function(r,t){var n=Object.keys(t),e=void 0;return r.forEach(function(r){r[n[0]]==t[n[0]]&&(e=r)}),e},r.searchIndex=function(r,t){for(var n=Object.keys(t),e=void 0,u=0;u<r.length;u++)r[u][n[0]]==t[n[0]]&&(e=u);return e},r.nextElementInArray=function(r,t){var n=Object.keys(t),e=void 0;return r.forEach(function(r,u,i){r[n[0]]==t[n[0]]&&(e=i[u+1])}),e},r.prevElementInArray=function(r,t){var n=Object.keys(t),e=void 0;return r.forEach(function(r,u,i){r[n[0]]==t[n[0]]&&(e=i[u-1])}),e},r.findString=function(r,t){var n=!1;return r.forEach(function(r){r===t&&(n=r)}),n},r.compareById=function(r,t){return r.id>t.id?-1:r.id<t.id?1:0},r.filterOrdersByStatus=function(t,n){var e=[];return t.forEach(function(t){r.findString(n,t.status)&&e.push(t)}),e},r.calculateOrderInfo=function(r){var t={price:0,count:0},n=!0,e=!1,u=void 0;try{for(var i,o=r.dishes[Symbol.iterator]();!(n=(i=o.next()).done);n=!0){var c=i.value;t.price+=c.dish.price*c.quantity,t.count+=c.quantity}}catch(a){e=!0,u=a}finally{try{!n&&o["return"]&&o["return"]()}finally{if(e)throw u}}return t},r.getDate=function(){var r=new Date,t=r.getDate(),n=r.getMonth()+1,e=r.getFullYear();t<10&&(t="0"+t),n<10&&(n="0"+n);var u=e+"-"+n+"-"+t;return{yyyy:e,mm:n,dd:t,str:u}},r.getHourMinutes=function(r){if(r)return{hours:r.substr(0,2),minutes:r.substr(2,4)}},r}angular.module("blocks.helpers",[]).factory("helpers",r),r.$inject=[]}();
"use strict";!function(){function e(e,a){return{restrict:"E",replace:!0,scope:{},require:"ngModel",templateUrl:"html/blocks/image-upload/image-upload.html",link:function(i,t,s,n){function r(e){for(var i=a.defer(),t=0,s=[],n=0;n<e.length;n++){var r=new FileReader;r.onload=function(a){t++,s.push(btoa(a.target.result)),t===e.length&&i.resolve(s)},r.readAsBinaryString(e[n])}return i.promise}function l(e){i.imagesDish.splice(i.imagesDish.indexOf(e),1),i.imagesDish.length||(i.uploaded=!1,n.$setValidity("arrayRequired",!1)),n.$setViewValue(i.imagesDish)}function o(e){for(var a={status:!0,reason:null},i=0;i<e.length;i++)e[i].size>c.max_filesize&&(a.status=!1,a.reason="max_filesize"),c.types.indexOf(e[i].type)===-1&&(a.status=!1,a.reason="format");return a}function u(a){var i="";switch(a.reason){case"max_filesize":i="Максимальний розмір файла 2Мб";break;case"format":i="Заборонений тип файлу"}e.error(i)}i.uploaded=!1,i.imagesDish=[],i.removeImage=l,i.$watch(function(){return n.$modelValue},function(e){e.length&&(i.uploaded=!0,i.imagesDish=n.$viewValue),n.$render()});var g=t.find("input"),c={max_filesize:2097152,types:["image/png","image/jpg","image/jpeg"]};g.on("change",function(t){var s=t.target.files,l=o(s);l.status?a.all([r(s)]).then(function(a){i.imagesDish=a[0],i.uploaded=!0,n.$setViewValue(a[0]),n.$setValidity("arrayRequired",!0),e.success("Изображения загружены")}):u(l)})}}}angular.module("blocks.image-upload",[]).directive("imageUpload",e),e.$inject=["toastr","$q"]}();
...
"use strict";!function(){function e(e,r){function s(){e.open({template:"html/modals/manager/order-detail.html",showClose:!1,appendClassName:r.getClassName()+" order-detail",controller:"managerOrderDetailCtrl",controllerAs:"vm"})}function o(){e.close()}var d={update:"update",create:"create",decline:"decline"},t=new r("managerOrderDetailModal",d),i=angular.extend(t,{show:s,hide:o});return i}function r(e,r,s,o,d,t,i,n,a,l){function c(e){var r=t.searchByKey(w.order.dishes,{dishId:e.dishId});r.quantity++}function u(e){var r=t.searchByKey(w.order.dishes,{dishId:e.dishId});r.quantity--,r.quantity||(m()?r.quantity++:w.order.dishes.splice(w.order.dishes.indexOf(r),1))}function h(e){if(!m()){var r=t.searchByKey(w.order.dishes,{dishId:e.dishId});w.order.dishes.splice(w.order.dishes.indexOf(r),1)}}function m(){return!(w.order.dishes.length-1)&&(n.error("Замовлення не можу бути порожнім!"),!0)}function f(){var e=angular.copy(w.order);r.scope.dishes=e.dishes,r.show()}function g(){o.history({clientPhone:w.order.client.phoneNumber},function(e){s.scope={orders:e,hideBack:!0},s.show()})}function v(){if(1==w.showCloseMessage)if(""!==w.closeMessage){var e={id:w.order.id,message:w.closeMessage,status:"DECLINED"};l.decline(e,function(){n.success("Замовлення відмінено")}),H.emit(H.events.decline,w.order),H.hide()}else n.error("Введіть причину відмови від замовлення");w.showCloseMessage=!0,w.closeBtnMessage="відмінити"}function p(){w.showCloseMessage=!1,w.closeBtnMessage="відміна замовлення"}function M(){w.order.dishes.length?w.createEnabled?D():y():n.error("Замовлення не можу бути порожнім!")}function D(){w.order.status="KITCHEN";var e=t.getDate(),r=O(w.order.timeToDeliver),s={id:w.order.id,client:{name:w.order.client.name,phone:w.order.client.phoneNumber,address:w.order.client.address},dishes:w.order.dishes,timeToDeliver:e.str+" "+r+":00",status:w.order.status};H.hide(),l.create(s,function(e){H.emit(H.events.create,e),n.success("Замовлення оформлено")})}function y(){w.order.status="KITCHEN";var e=t.getDate(),r=O(w.order.timeToDeliver),s={id:w.order.id,client:{name:w.order.client.name,phone:w.order.client.phoneNumber,address:w.order.client.address},dishes:w.order.dishes,timeToDeliver:e.str+" "+r+":00",status:w.order.status};H.emit(H.events.update,w.order),H.hide(),l.update(s,function(){n.success("Замовлення оформлено")})}function C(e){var r=!1,s=i.run(e.client,N),o=i.run(e,T);return s.errors.length||o.errors.length||(r=!0),r}function I(e){var r=d("date")(e,"HH:mm"),s=t.getHourMinutes(r);return""+s.hours+s.minutes}function O(e){var r=t.getHourMinutes(e);if(r)return r.hours+":"+r.minutes}var w=this,H=e.get("managerOrderDetailModal"),N=[{field:"name",rules:["required"]},{field:"address",rules:["required"]},{field:"phoneNumber",rules:["required","phone"]}],T=[{field:"dishes",rules:["required"]},{field:"timeToDeliver",rules:["required"]}];if(w.createEnabled=H.scope.createEnabled,w.createEnabled){var b={client:{address:"",name:"",phoneNumber:""},dishes:[],status:"FRESH"};w.order=b}else{var q=H.scope.order;q.timeToDeliver&&(q.timeToDeliver=I(q.timeToDeliver)),w.order=q}w.closeMessage="",w.showCloseMessage=!!w.closeMessage,w.closeBtnMessage=w.closeMessage?"відмінити":"відміна замовлення",w.orderInfo=t.calculateOrderInfo(w.order),w.orderValid=!0,w.selectDishesModal=f,w.historyOrdersModal=g,w.incQuantity=c,w.decQuantity=u,w.removeDish=h,w.showCloseOrderForm=v,w.hideCloseOrderForm=p,w.saveOrder=M,w.convertHHmm=O,a.$watch(function(){return w.order.dishes},function(){w.orderInfo=t.calculateOrderInfo(w.order)},!0),a.$watch(function(){return w.order},function(e){C(e)?w.orderValid=!0:w.orderValid=!1},!0),r.on(r.events.selected,function(e){w.order.dishes=e})}angular.module("app.modals").factory("managerOrderDetailModal",e).controller("managerOrderDetailCtrl",r),e.$inject=["ngDialog","BaseModal"],r.$inject=["BaseModal","dishesSelectModal","orderHistoryModal","admin","$filter","helpers","validator","toastr","$scope","orders"]}();
"use strict";!function(){function e(e,t,s,i,n,o,c,r){function d(){return n.fetchAll().$promise.then(function(e){return g.categories=e,e[0]}).then(function(e){return n.fetchDishes({id:e.id}).$promise.then(function(t){return g.selectedCategory=e,g.dishes=t,g.dishes})})}function a(e){g.spinner=!0,n.fetchDishes({id:e.id},function(t){g.selectedCategory=e,g.dishes=t,f()})}function h(){var e="Ви справді бажаєте видалити категорію - "+g.selectedCategory.name+"?";confirm(e)&&n.remove({id:g.selectedCategory.id},function(){var e=i.searchByKey(g.categories,{id:g.selectedCategory.id});g.categories.splice(g.categories.indexOf(e),1),g.selectedCategory=g.categories[0],a(g.categories[0]),r.success("Категорія видалена")})}function l(e){var t="Ви справді бажаєте видалити страву?";confirm(t)&&n.removeDish({id:g.selectedCategory.id,dishes:[{id:e}]},function(){var t=i.searchByKey(g.dishes,{id:e});g.dishes.splice(g.dishes.indexOf(t),1),r.success("Страву видалено")})}function u(e){var s=angular.extend({categoryId:g.selectedCategory.id},e);t.scope=s,t.show()}function f(){o(function(){g.spinner=!1},400)}var g=this;e.scope=g,g.spinner=!0,g.loadDishes=a,g.removeDish=l,g.removeCategory=h,g.showModalDishAdd=e.show,g.showModalCategoryAdd=s.show,g.showModalDishEdit=u,g.selectedCategory,c.all([d()]).then(function(){f()}),e.on(e.events.create,function(){n.fetchDishes({id:g.selectedCategory.id},function(e){g.dishes=e})}),t.on(t.events.update,function(e){n.fetchDishes({id:g.selectedCategory.id},function(e){g.dishes=e})}),s.on(s.events.create,function(){n.fetchAll({},function(e){g.categories=e})})}angular.module("app.admin.panel").controller("Panel",e),e.$inject=["dishesCreateModal","dishesEditModal","categoriesCreateModal","helpers","categories","$timeout","$q","toastr"]}();
