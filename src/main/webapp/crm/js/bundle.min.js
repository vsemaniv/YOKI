...
"use strict";!function(){function a(a){return a("/images/:action/:data",{},{fetchAll:{method:"POST",isArray:!0,params:{action:"getDishImages"}},upload:{method:"POST",transformRequest:angular.identity,headers:{"Content-Type":void 0},params:{action:"addImages"}}})}angular.module("app.resources").factory("images",a),a.$inject=["$resource"]}();
...
"use strict";!function(){function e(e,a){return{restrict:"E",replace:!0,scope:{},require:"ngModel",templateUrl:"html/blocks/image-upload/image-upload.html",link:function(i,t,r,s){function n(e){for(var i=a.defer(),t=0,r=[],s=0;s<e.length;s++){var n=new FileReader;n.onload=function(a){t++,r.push(btoa(a.target.result)),t===e.length&&i.resolve(r)},n.readAsBinaryString(e[s])}return i.promise}function l(e){i.imagesDish.splice(i.imagesDish.indexOf(e),1),i.imagesDish.length||(i.uploaded=!1,s.$setValidity("arrayRequired",!1)),s.$setViewValue(i.imagesDish)}function o(e){for(var a={status:!0,reason:null},i=0;i<e.length;i++)e[i].size>m.max_filesize&&(a.status=!1,a.reason="max_filesize"),m.types.indexOf(e[i].type)===-1&&(a.status=!1,a.reason="format");return a}function u(a){var i="";switch(a.reason){case"max_filesize":i="Максимальний розмір файла 2Мб";break;case"format":i="Заборонений тип файлу"}e.error(i)}i.uploaded=!1,i.imagesDish=[],i.removeImage=l;var g=t.find("input"),m={max_filesize:2097152,types:["image/png","image/jpg","image/jpeg"]};g.on("change",function(e){var t=[];angular.forEach(e.target.files,function(e){t.push(e)});var r=o(t);r.status?a.all([n(t)]).then(function(e){i.imagesDish=e[0],i.uploaded=!0,s.$setViewValue(t),s.$setValidity("arrayRequired",!0)}):u(r)})}}}angular.module("blocks.image-upload",[]).directive("imageUpload",e),e.$inject=["toastr","$q"]}();
...
"use strict";!function(){function e(e,a){function t(){e.open({template:"html/modals/dishes/create.html",width:"60%",showClose:!1,controller:"dishesCreateModalCtrl",controllerAs:"vm"})}function o(){e.close()}var n={create:"create"},s=new a("dishesCreateModal",n),r=angular.extend(s,{show:t,hide:o});return r}function a(e,a,t,o){function n(){s.spinner=!0,console.log(s.form),e.create(s.form,function(e){var t=new FormData;t.append("id",e.id),t.append("type","dish"),s.form.images.forEach(function(e){console.log(e),t.append("images[]",e)}),a.upload(t,function(){s.spinner=!1,r.hide(),o.success("Страву добавлена"),r.emit(r.events.create)})})}var s=this,r=t.get("dishesCreateModal");s.create=n,s.spinner=!1,s.form={images:[],name:"",price:"",description:"",type:"ORDINARY",categoryId:r.scope.selectedCategory.id},s.types=[{name:"Звичайний",value:"ORDINARY"},{name:"Новинка",value:"LATEST"},{name:"Гостра страва",value:"HOT"},{name:"Вегетаріанська страва",value:"VEGAN"}]}angular.module("app.modals").factory("dishesCreateModal",e).controller("dishesCreateModalCtrl",a),e.$inject=["ngDialog","BaseModal"],a.$inject=["dishes","images","BaseModal","toastr"]}();
"use strict";!function(){function e(e,n){function i(){e.open({template:"html/modals/dishes/edit.html",width:"60%",showClose:!1,controller:"dishesEditModalCtrl",controllerAs:"vm"})}function s(){e.close()}var t={update:"update"},o=new n("dishesEditModal",t),a=angular.extend(o,{show:i,hide:s});return a}function n(e,n,i,s){function t(){a.spinner=!0;var e={dishId:d.scope.id,links:[]};d.scope.images.forEach(function(n){e.links.push(n.link)}),n.fetchAll([e],function(e){a.spinner=!1,a.form.images=e[0].images})}function o(){a.spinner=!0,e.update(a.form,function(e){a.spinner=!1,d.hide(),s.success("Страву обновлено"),d.emit(d.events.update,e)},function(){a.spinner=!1})}var a=this,d=i.get("dishesEditModal");a.update=o,a.spinner=!1,a.form={images:[],id:d.scope.id,name:d.scope.name,price:d.scope.price,description:d.scope.description,type:d.scope.type,categoryId:d.scope.categoryId},a.types=[{name:"Звичайний",value:"ORDINARY"},{name:"Новинка",value:"LATEST"},{name:"Гостра страва",value:"HOT"},{name:"Вегетаріанська страва",value:"VEGAN"}],t()}angular.module("app.modals").factory("dishesEditModal",e).controller("dishesEditModalCtrl",n),e.$inject=["ngDialog","BaseModal"],n.$inject=["dishes","images","BaseModal","toastr"]}();
...
"use strict";!function(){function e(e,r){function s(){e.open({template:"html/modals/manager/order-detail.html",showClose:!1,appendClassName:r.getClassName()+" order-detail",controller:"managerOrderDetailCtrl",controllerAs:"vm"})}function o(){e.close()}var d={update:"update",create:"create",decline:"decline"},t=new r("managerOrderDetailModal",d),i=angular.extend(t,{show:s,hide:o});return i}function r(e,r,s,o,d,t,i,n,a){function l(e){var r=d.searchByKey(I.order.dishes,{dishId:e.dishId});r.quantity++}function c(e){var r=d.searchByKey(I.order.dishes,{dishId:e.dishId});r.quantity--,r.quantity||(h()?r.quantity++:I.order.dishes.splice(I.order.dishes.indexOf(r),1))}function u(e){if(!h()){var r=d.searchByKey(I.order.dishes,{dishId:e.dishId});I.order.dishes.splice(I.order.dishes.indexOf(r),1)}}function h(){return!(I.order.dishes.length-1)&&(i.error("Замовлення не можу бути порожнім!"),!0)}function f(){var e=angular.copy(I.order);r.scope.dishes=e.dishes,r.show()}function m(){o.history({clientPhone:I.order.client.phoneNumber},function(e){s.scope={orders:e,hideBack:!0},s.show()})}function g(){if(1==I.showCloseMessage)if(""!==I.closeMessage){var e={id:I.order.id,message:I.closeMessage,status:"DECLINED"};a.decline(e,function(){i.success("Замовлення відмінено")}),O.emit(O.events.decline,I.order),O.hide()}else i.error("Введіть причину відмови від замовлення");I.showCloseMessage=!0,I.closeBtnMessage="відмінити"}function v(){I.showCloseMessage=!1,I.closeBtnMessage="відміна замовлення"}function p(){I.order.dishes.length?I.createEnabled?M():D():i.error("Замовлення не можу бути порожнім!")}function M(){I.order.status="KITCHEN";var e=null;if(I.order.timeToDeliver){var r=d.getDate(),s=C(I.order.timeToDeliver);e=r.str+" "+s+":00"}var o={id:I.order.id,client:{name:I.order.client.name,phone:I.order.client.phoneNumber,address:I.order.client.address},dishes:I.order.dishes,timeToDeliver:e,status:I.order.status};O.hide(),a.create(o,function(e){O.emit(O.events.create,e),i.success("Замовлення оформлено")})}function D(){I.order.status="KITCHEN";var e=null;if(I.order.timeToDeliver){var r=d.getDate(),s=C(I.order.timeToDeliver);e=r.str+" "+s+":00"}var o={id:I.order.id,client:{name:I.order.client.name,phone:I.order.client.phoneNumber,address:I.order.client.address},dishes:I.order.dishes,timeToDeliver:e,status:I.order.status};O.emit(O.events.update,I.order),O.hide(),a.update(o,function(){i.success("Замовлення оформлено")})}function y(e){var r=!1,s=t.run(e.client,w),o=t.run(e,N);return s.errors.length||o.errors.length||(r=!0),r}function C(e){if(e){var r=d.getHourMinutes(e);if(r)return r.hours+":"+r.minutes}}var I=this,O=e.get("managerOrderDetailModal"),w=[{field:"name",rules:["required"]},{field:"address",rules:["required"]},{field:"phoneNumber",rules:["required","phone"]}],N=[{field:"dishes",rules:["required"]}];if(I.createEnabled=O.scope.createEnabled,I.createEnabled){var b={client:{address:"",name:"",phoneNumber:""},dishes:[],status:"FRESH"};I.order=b}else I.order=O.scope.order;I.closeMessage="",I.showCloseMessage=!!I.closeMessage,I.closeBtnMessage=I.closeMessage?"відмінити":"відміна замовлення",I.orderInfo=d.calculateOrderInfo(I.order),I.orderValid=!0,I.selectDishesModal=f,I.historyOrdersModal=m,I.incQuantity=l,I.decQuantity=c,I.removeDish=u,I.showCloseOrderForm=g,I.hideCloseOrderForm=v,I.saveOrder=p,I.convertHHmm=C,n.$watch(function(){return I.order.dishes},function(){I.orderInfo=d.calculateOrderInfo(I.order)},!0),n.$watch(function(){return I.order},function(e){y(e)?I.orderValid=!0:I.orderValid=!1},!0),r.on(r.events.selected,function(e){I.order.dishes=e})}angular.module("app.modals").factory("managerOrderDetailModal",e).controller("managerOrderDetailCtrl",r),e.$inject=["ngDialog","BaseModal"],r.$inject=["BaseModal","dishesSelectModal","orderHistoryModal","admin","helpers","validator","toastr","$scope","orders"]}();
...
"use strict";!function(){function e(e,r,o,i,t,n,s){function a(){return e.fetchAll({}).$promise.then(function(e){m.callCenter=c(e,p.callCenter).sort(n.compareById),m.kitchen=c(e,p.kitchen).sort(n.compareById),m.delivery=c(e,p.delivery).sort(n.compareById),m.ordersLoading=!1})}function c(e,r){var o=[];return e.forEach(function(e){n.findString(r,e.status)&&o.push(e)}),o}function u(e){g=e,g.timeToDeliver&&(g.timeToDeliver=n.parseDate(g.timeToDeliver)),s.open({template:"html/modals/order-detail-admin.html",className:"ngdialog-theme-default order-detail",controller:f})}function d(e){var r={price:0,count:0},o=!0,i=!1,t=void 0;try{for(var n,s=e.dishes[Symbol.iterator]();!(o=(n=s.next()).done);o=!0){var a=n.value;r.price+=a.dish.price*a.quantity,r.count+=a.quantity}}catch(c){i=!0,t=c}finally{try{!o&&s["return"]&&s["return"]()}finally{if(i)throw t}}return r}function l(e){var r=n.searchByKey(m.kitchen,{id:e.id});m.kitchen.splice(m.kitchen.indexOf(r),1),m.delivery.push(e),m.delivery.sort(n.compareById)}function f(e,r,o,i){function t(){v=s.open({template:"html/modals/order-delivery-admin.html",width:"350px",showClose:!1,controller:h})}function n(){g.status="COOKING",i.makeInCooking({id:g.id},function(){o.success("Замовлення відправлено на кухню")}),s.close()}function a(e){if(e){var o=r.getHourMinutes(e);if(o)return o.hours+":"+o.minutes}}e.order=g,e.closeMessage="",e.showCloseMessage=!!e.closeMessage,e.closeBtnMessage=e.closeMessage?"відмінити":"відміна замовлення",e.orderInfo=d(g),e.showModalDelivery=t,e.makeInCooking=n,e.convertHHmm=a,e.showCloseOrderForm=function(){if(1==e.showCloseMessage)if(""!==e.closeMessage){var t={id:e.order.id,status:"CANT_PREPARE",message:e.closeMessage};i.declineOrder(t,function(){o.success("Замовлення відмінено")});var n=r.searchByKey(m.kitchen,{id:g.id});m.kitchen.splice(m.kitchen.indexOf(n),1),m.kitchen.sort(r.compareById),s.close()}else o.error("Введіть причину відмови від замовлення");e.showCloseMessage=!0,e.closeBtnMessage="відмінити"},e.hideCloseOrderForm=function(){e.showCloseMessage=!1,e.closeBtnMessage="відміна замовлення"},e.passOrder=function(){g.courierDetails?(i.passOrderToCourier({id:g.id},function(){o.success("Замовлення видано кур’єру")}),g.status="DELIVERY",l(g),s.close()):o.warning("Необхідно назначити кур’єра на замовлення!")}}function h(e,r,o,i){function t(){o.fetchAll({},function(r){e.courierList=l(r),e.pageLoading=!1})}function s(){v.close()}function a(r){"BUSY"===r.status?i.warning("Кур’єр зайнятий"):(c(r),e.formCourier.id=r.id,r.showForm=!r.showForm)}function c(r){e.courierList.forEach(function(e){e.id!==r.id&&(e.showForm=!1)})}function u(o){var t=n.getDate();if(d()){var a=t.yyyy+"-"+t.mm+"-"+t.dd,c=n.getHourMinutes(e.formCourier.start),u=n.getHourMinutes(e.formCourier.finish);r.setOrderToCourier({timeToTake:a+" "+c.hours+":"+c.minutes+":00",timeToDeliver:a+" "+u.hours+":"+u.minutes+":00",id:g.id,courierId:o.id}),g.courierDetails=o,i.success("Інформація передана кур’єру"),s()}else i.error("Необхідно заповнити всі поля")}function d(){var r=!0;for(var o in e.formCourier)e.formCourier.hasOwnProperty(o)&&(e.formCourier[o]||(r=!1));return r}function l(e){var r=e.filter(function(e){if("OUT"!==e.status)return!0});return r.map(function(e){var r="FREE"===e.status,o=r?"вільний":"зайнятий";return{account:e.account,id:e.id,messagingToken:e.messagingToken,status:e.status,statusText:o,free:r,showForm:!1}})}e.closeModal=s,e.showForm=a,e.sendCourier=u,e.courierList=[],e.pageLoading=!0,e.formCourier={id:0,start:"",finish:""},t()}var m=this;m.callCenter=[],m.kitchen=[],m.delivery=[],m.ordersLoading=!0,m.showModalOrder=u;var g=void 0,v=void 0,p={callCenter:["FRESH","IN_PROGRESS"],kitchen:["KITCHEN","COOKING","PREPARED"],delivery:["DELIVERY","DONE"]};a(),o.$on(r.refreshPage,function(){i.all([a()]).then(function(){o.$emit(r.refreshPageDone)})}),f.$inject=["$scope","helpers","toastr","admin"],h.$inject=["$scope","admin","courier","toastr"]}angular.module("app.admin.dashboard").controller("DashboardAdmin",e),e.$inject=["orders","APP_EVENTS","$scope","$q","admin","helpers","ngDialog"]}();
...
"use strict";!function(){function e(e,t,s,i,o,n,c,r){function d(){return o.fetchAll().$promise.then(function(e){return g.categories=e,e[0]}).then(function(e){return o.fetchDishes({id:e.id}).$promise.then(function(t){g.selectedCategory=e,g.dishes=t})})}function a(e){g.spinner=!0,o.fetchDishes({id:e.id},function(t){g.selectedCategory=e,g.dishes=t,console.log(t),f()})}function h(){var e="Ви справді бажаєте видалити категорію - "+g.selectedCategory.name+"?";confirm(e)&&o.remove({id:g.selectedCategory.id},function(){var e=i.searchByKey(g.categories,{id:g.selectedCategory.id});g.categories.splice(g.categories.indexOf(e),1),g.selectedCategory=g.categories[0],a(g.categories[0]),r.success("Категорія видалена")})}function l(e){var t="Ви справді бажаєте видалити страву?";confirm(t)&&o.removeDish({id:g.selectedCategory.id,dishes:[{id:e}]},function(){var t=i.searchByKey(g.dishes,{id:e});g.dishes.splice(g.dishes.indexOf(t),1),r.success("Страву видалено")})}function u(e){var s=angular.extend({categoryId:g.selectedCategory.id},e);t.scope=s,t.show()}function f(){n(function(){g.spinner=!1},400)}var g=this;e.scope=g,g.spinner=!0,g.loadDishes=a,g.removeDish=l,g.removeCategory=h,g.showModalDishAdd=e.show,g.showModalCategoryAdd=s.show,g.showModalDishEdit=u,g.selectedCategory,c.all([d()]).then(function(){f()}),e.on(e.events.create,function(){o.fetchDishes({id:g.selectedCategory.id},function(e){g.dishes=e})}),t.on(t.events.update,function(e){o.fetchDishes({id:g.selectedCategory.id},function(e){g.dishes=e})}),s.on(s.events.create,function(){o.fetchAll({},function(e){g.categories=e})})}angular.module("app.admin.panel").controller("Panel",e),e.$inject=["dishesCreateModal","dishesEditModal","categoriesCreateModal","helpers","categories","$timeout","$q","toastr"]}();
...
"use strict";!function(){function e(e,r,n,i,t,a,o){function c(){return e.fetchAll({}).$promise.then(function(e){f.callCenter=d(e,v.callCenter).sort(t.compareById),f.kitchen=d(e,v.kitchen).sort(t.compareById),f.delivery=d(e,v.delivery).sort(t.compareById),f.ordersLoading=!1})}function d(e,r){var n=[];return e.forEach(function(e){t.findString(r,e.status)&&n.push(e)}),n}function s(e,r){p=u(e),y=r,"FRESH"===p.status&&l(p);var n=angular.copy(p);n.timeToDeliver&&(n.timeToDeliver=t.parseDate(n.timeToDeliver)),r?(a.scope.createEnabled=!1,a.scope.order=n,a.show()):(o.scope.order=n,o.show())}function l(r){r.status="IN_PROGRESS",e.makeInProgress({id:r.id})}function u(e){return e.dishes=e.dishes.map(function(e){return{dish:e.dish,id:e.id,dishId:e.dish.id,quantity:e.quantity}}),e}function h(e){var r=t.searchByKey(f.callCenter,{id:e.id});f.callCenter.splice(f.callCenter.indexOf(r),1),f.kitchen.push(e),f.kitchen.sort(t.compareById)}var f=this;f.callCenter=[],f.kitchen=[],f.delivery=[],f.ordersLoading=!0,f.showModalOrder=s,f.makeInProgress=l;var p=void 0,y=!0,v={callCenter:["FRESH","IN_PROGRESS"],kitchen:["KITCHEN","COOKING","PREPARED"],delivery:["DELIVERY","DONE"]};c(),n.$on(r.refreshPage,function(){i.all([c()]).then(function(){n.$emit(r.refreshPageDone)})}),a.on(a.events.create,function(e){f.kitchen.push(e),f.kitchen.sort(t.compareById)}),a.on(a.events.update,function(e){h(e)}),a.on(a.events.decline,function(e){var r=t.searchByKey(f.callCenter,{id:e.id});f.callCenter.splice(f.callCenter.indexOf(r),1),f.callCenter.sort(t.compareById)}),o.on(o.events.decline,function(e){var r=t.searchByKey(f.delivery,{id:e.id});f.delivery.splice(f.delivery.indexOf(r),1),f.delivery.sort(t.compareById)})}angular.module("app.manager.dashboard").controller("DashboardManager",e),e.$inject=["orders","APP_EVENTS","$scope","$q","helpers","managerOrderDetailModal","managerOrderDetailMiniModal"]}();
