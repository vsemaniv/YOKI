...
"use strict";!function(){function r(r,e,n,o,a,i,t){function l(){var r="адміністратор",e=t.roles();return a.findString(e,i.manager)&&(r="менеджер"),a.findString(e,i.kitchen)&&(r="кухня"),r}function d(){e.scope.createEnabled=!0,e.show()}function s(){n.show()}function c(){o.show()}var u=this;u.roleName=l(),u.orderHistory=r.show,u.createNewOrder=d,u.callCourier=s,u.ingredients=c}angular.module("app.layout").controller("Header",r),r.$inject=["orderHistoryIntervalModal","managerOrderDetailModal","adminCallCourierModal","ingredientsModal","helpers","USER_ROLES","user"]}();
...
"use strict";!function(){function a(a){return a("/dish/:action/:data",{},{create:{method:"POST",params:{action:"create"}},update:{method:"POST",params:{action:"update"}},activate:{method:"POST",params:{action:"activate"}},deactivate:{method:"POST",params:{action:"deactivate"}},getIngredients:{method:"POST",isArray:!0,params:{action:"getIngredients"}}})}angular.module("app.resources").factory("dishes",a),a.$inject=["$resource"]}();
"use strict";!function(){function e(e){return e("/images/:action/:data",{},{remove:{method:"POST",params:{action:"removeDishImages"}},upload:{method:"POST",transformRequest:angular.identity,headers:{"Content-Type":void 0},params:{action:"addImages"}}})}angular.module("app.resources").factory("images",e),e.$inject=["$resource"]}();
"use strict";!function(){function e(e){return e("/ingredient/:action/:data",{},{create:{method:"POST",params:{action:"create"}},update:{method:"POST",params:{action:"update"}},remove:{method:"POST",params:{action:"remove"}},fetchAll:{method:"POST",isArray:!0,params:{action:"getAll"}}})}angular.module("app.resources").factory("ingredients",e),e.$inject=["$resource"]}();
...
"use strict";!function(){function r(r,t){var n={};return n.shapeArrayInRows=function(r,t){for(var n=[],e=0;e<r.length;e+=t)n.push(r.slice(e,e+t));return n},n.searchByKey=function(r,t){var n=Object.keys(t),e=void 0;return r.forEach(function(r){r[n[0]]==t[n[0]]&&(e=r)}),e},n.searchIndex=function(r,t){for(var n=Object.keys(t),e=void 0,u=0;u<r.length;u++)r[u][n[0]]==t[n[0]]&&(e=u);return e},n.nextElementInArray=function(r,t){var n=Object.keys(t),e=void 0;return r.forEach(function(r,u,i){r[n[0]]==t[n[0]]&&(e=i[u+1])}),e},n.prevElementInArray=function(r,t){var n=Object.keys(t),e=void 0;return r.forEach(function(r,u,i){r[n[0]]==t[n[0]]&&(e=i[u-1])}),e},n.findString=function(r,t){var n=!1;return r.forEach(function(r){r===t&&(n=r)}),n},n.compareById=function(r,t){return r.id>t.id?-1:r.id<t.id?1:0},n.compareByCantPrepare=function(r,t){return"CANT_PREPARE"===r.status?-1:1},n.filterOrdersByStatus=function(r,t){var e=[];return r.forEach(function(r){n.findString(t,r.status)&&e.push(r)}),e},n.calculateOrderInfo=function(r){var t={price:0,count:0},n=!0,e=!1,u=void 0;try{for(var i,o=r.dishes[Symbol.iterator]();!(n=(i=o.next()).done);n=!0){var a=i.value;t.price+=a.dish.price*a.quantity,t.count+=a.quantity}}catch(c){e=!0,u=c}finally{try{!n&&o["return"]&&o["return"]()}finally{if(e)throw u}}return t},n.getDate=function(){var r=new Date,t=r.getDate(),n=r.getMonth()+1,e=r.getFullYear();t<10&&(t="0"+t),n<10&&(n="0"+n);var u=e+"-"+n+"-"+t;return{yyyy:e,mm:n,dd:t,str:u}},n.getHourMinutes=function(r){if(r)return{hours:r.substr(0,2),minutes:r.substr(2,4)}},n.parseDate=function(t){var e=r("date")(t,"HHmm"),u=n.getHourMinutes(e);return""+u.hours+u.minutes},n.convertHHmm=function(r){if(r){var t=n.getHourMinutes(r);if(t)return t.hours+":"+t.minutes}},n.fullPath=function(r){return t.apiUrl+r},n}angular.module("blocks.helpers",[]).factory("helpers",r),r.$inject=["$filter","ENV"]}();
...
"use strict";!function(){function e(e,n,i){return{restrict:"E",replace:!0,scope:{onAdd:"&"},templateUrl:"html/blocks/ingredients/ingredient-add.html",link:function(t,r){function a(e){for(var n=i.defer(),t=0,r=[],a=0;a<e.length;a++){var o=new FileReader;o.onload=function(i){t++,r.push(btoa(i.target.result)),t===e.length&&n.resolve(r)},o.readAsBinaryString(e[a])}return n.promise}var o=r.find("input");o.on("change",function(e){var n=[];angular.forEach(e.target.files,function(e){n.push(e)}),i.all([a(n)]).then(function(e){t.previewImage=e[0],t.file=n[0]})}),t.name="",t.save=function(){t.onAdd(),t.name&&t.file&&!function(){var i=t.name,r=t.file;e.create({name:i},function(e){var i=new FormData;i.append("id",e.id),i.append("type","ingredient"),i.append("images[]",r),n.upload(i,function(){t.onAdd(),t.remove()})})}()},t.remove=function(){r.remove(),t.$destroy()}}}}angular.module("blocks.ingredient-add",[]).directive("ingredientAdd",e),e.$inject=["ingredients","images","$q"]}();
"use strict";!function(){function e(e,n,t,i,a){return{restrict:"E",replace:!0,scope:{data:"<",onEdit:"&"},templateUrl:"html/blocks/ingredients/ingredient-edit.html",link:function(d,r){function o(e){for(var n=a.defer(),t=0,i=[],d=0;d<e.length;d++){var r=new FileReader;r.onload=function(a){t++,i.push(btoa(a.target.result)),t===e.length&&n.resolve(i)},r.readAsBinaryString(e[d])}return n.promise}var l=r.find("input"),u=null;l.on("change",function(e){var n=[];angular.forEach(e.target.files,function(e){n.push(e)}),a.all([o(n)]).then(function(e){d.previewImage=e[0],d.file=n[0]})}),d.editMode=!1,d.fullPath=i.fullPath,d.editModeOn=function(){d.editMode=!0,u=angular.copy(d.data)},d.editModeOff=function(){d.editMode=!1,d.previewImage=null,d.data=u},d.save=function(){if(d.data.name&&(n.update({id:d.data.id,name:d.data.name},function(){d.onEdit(),d.editModeOff(),e.success("Інгредієнт обновлено")}),d.file)){var i=new FormData;i.append("id",d.data.id),i.append("type","ingredient"),i.append("images[]",d.file),t.upload(i,function(){d.onEdit()})}},d.remove=function(){confirm("Видалити інгредієнт?")&&n.remove({id:d.data.id},function(){e.success("Інгредієнт видалено")})},r.bind("keydown keypress",function(e){13===e.which&&(d.$apply(function(){d.save()}),e.preventDefault())});var c=r[0].getElementsByClassName("ingredient-text"),f=angular.element(c);f.bind("click",function(){d.$apply(function(){d.editModeOn()}),event.preventDefault()})}}}angular.module("blocks.ingredient-edit",[]).directive("ingredientEdit",e),e.$inject=["toastr","ingredients","images","helpers","$q"]}();
...
"use strict";!function(){function n(n,e){function t(){n.open({template:"html/modals/admin/ingredients.html",width:"500px",showClose:!1,controller:"ingredientsModalCtrl",controllerAs:"vm"})}function i(){n.close()}var o=new e("ingredientsModal"),d=angular.extend(o,{show:t,hide:i});return d}function e(n,e,t,i,o){function d(){c()}function r(){c()}function l(){c()}function a(){u.hide()}function s(){var n=t('<ingredient-add on-add="vm.onAddIngredient()"></ingredient-add>')(o),e=document.getElementsByClassName("add-li-area"),i=angular.element(e);i.after(n)}function c(){g.spinner=!0,e.fetchAll({},function(n){g.ingredients=n,i(function(){g.spinner=!1},400)})}var g=this,u=n.get("ingredientsModal");g.ingredients=[],g.spinner=!0,g.newIngredient=s,g.onAddIngredient=r,g.onEditIngredient=l,g.closeModal=a,d()}angular.module("app.modals").factory("ingredientsModal",n).controller("ingredientsModalCtrl",e),n.$inject=["ngDialog","BaseModal"],e.$inject=["BaseModal","ingredients","$compile","$timeout","$scope"]}();
...
"use strict";!function(){function o(o,e){function r(){o.open({template:"html/modals/history/history.html",showClose:!1,appendClassName:e.getClassName()+" orders-history",controller:"orderHistoryModalCtrl",controllerAs:"vm"})}function t(){o.close()}var s=new e("orderHistoryModal"),a=angular.extend(s,{show:r,hide:t});return a}function e(o,e,r){function t(){l.hide(),r.show()}function s(o){return o.map(function(o){return angular.extend(o,{showDetail:!1,dishesLoad:!1})})}function a(o){o.showDetail||e.getDishes({id:o.id},function(e){o.dishes=e,o.dishesLoad=!0}),o.showDetail=!o.showDetail}var i=this,l=o.get("orderHistoryModal");i.orders=s(l.scope.orders),i.hideBack=l.scope.hideBack,i.showIntervalModal=t,i.toggleOrderDetail=a}angular.module("app.modals").factory("orderHistoryModal",o).controller("orderHistoryModalCtrl",e),o.$inject=["ngDialog","BaseModal"],e.$inject=["BaseModal","orders","orderHistoryIntervalModal"]}();
...
"use strict";!function(){function e(e,n){function t(){e.open({template:"html/modals/dishes/create.html",width:"60%",showClose:!1,controller:"dishesCreateModalCtrl",controllerAs:"vm"})}function a(){e.close()}var i={create:"create"},r=new n("dishesCreateModal",i),s=angular.extend(r,{show:t,hide:a});return s}function n(e,n,t,a,i){function r(){t.fetchAll({},function(e){o.ingredients=e})}function s(){var t=o.ingredients.filter(function(e){return e.selected}),a=t.map(function(e){return e.id});a.length?(o.spinner=!0,o.form.ingredientIds=a,e.create(o.form,function(e){var t=new FormData;t.append("id",e.id),t.append("type","dish"),o.form.images.forEach(function(e){t.append("images[]",e)}),n.upload(t,function(){o.spinner=!1,d.hide(),i.success("Страву додано"),d.emit(d.events.create)})},function(){o.spinner=!1})):i.warning("Виберіть інгредієнти")}var o=this,d=a.get("dishesCreateModal");o.create=s,o.ingredients=[],o.form={images:[],name:"",price:"",description:"",type:"ORDINARY",ingredientIds:[],categoryId:d.scope.selectedCategory.id},o.types=[{name:"Звичайний",value:"ORDINARY"},{name:"Новинка",value:"LATEST"},{name:"Гостра страва",value:"HOT"},{name:"Вегетаріанська страва",value:"VEGAN"}],r()}angular.module("app.modals").factory("dishesCreateModal",e).controller("dishesCreateModalCtrl",n),e.$inject=["ngDialog","BaseModal"],n.$inject=["dishes","images","ingredients","BaseModal","toastr"]}();
"use strict";!function(){function e(e,n){function i(){e.open({template:"html/modals/dishes/edit.html",width:"60%",showClose:!1,controller:"dishesEditModalCtrl",controllerAs:"vm"})}function t(){e.close()}var s={update:"update"},o=new n("dishesEditModal",s),d=angular.extend(o,{show:i,hide:t});return d}function n(e,n,i,t,s,o){function d(){t.fetchAll({},function(n){c.ingredients=n,e.getIngredients({id:c.form.id},function(e){c.ingredients.forEach(function(n){i.searchByKey(e,{id:n.id})&&(n.selected=!0)})})})}function a(){var i=c.ingredients.filter(function(e){return e.selected}),t=i.map(function(e){return e.id});t.length?(c.spinner=!0,c.form.ingredientIds=t,r()?e.update(c.form,function(e){var i=new FormData;i.append("id",c.form.id),i.append("type","dish"),c.form.images.forEach(function(e){i.append("images[]",e)}),n.upload(i,function(){c.spinner=!1,p.hide(),o.success("Страву обновлено"),p.emit(p.events.update,e)})},function(){c.spinner=!1}):e.update(c.form,function(e){c.spinner=!1,p.hide(),o.success("Страву обновлено"),p.emit(p.events.update,e)},function(){c.spinner=!1})):o.warning("Виберіть інгредієнти")}function r(){var e=!1;return c.form.images.forEach(function(n){n.type&&(e=!0)}),e}var c=this,p=s.get("dishesEditModal");c.update=a,c.ingredients=[],c.spinner=!1,c.form={images:p.scope.images,id:p.scope.id,name:p.scope.name,price:p.scope.price,description:p.scope.description,type:p.scope.type,ingredientIds:[],categoryId:p.scope.categoryId},c.types=[{name:"Звичайний",value:"ORDINARY"},{name:"Новинка",value:"LATEST"},{name:"Гостра страва",value:"HOT"},{name:"Вегетаріанська страва",value:"VEGAN"}],d()}angular.module("app.modals").factory("dishesEditModal",e).controller("dishesEditModalCtrl",n),e.$inject=["ngDialog","BaseModal"],n.$inject=["dishes","images","helpers","ingredients","BaseModal","toastr"]}();
...
"use strict";!function(){function e(e,s){function o(){e.open({template:"html/modals/manager/order-detail-mini.html",showClose:!1,appendClassName:s.getClassName()+" order-detail",controller:"managerOrderDetailMiniCtrl",controllerAs:"vm"})}function r(){e.close()}var n={decline:"decline"},a=new s("managerOrderDetailMiniModal",n),l=angular.extend(a,{show:o,hide:r});return l}function s(e,s,o,r,n,a){function l(){g.spinner=!0,g.order=u.scope.order,n.getDishes({id:g.order.id},function(e){g.order.dishes=e,g.orderInfo=s.calculateOrderInfo(g.order),setTimeout(function(){r.$apply(function(){g.spinner=!1})},500)})}function i(){if(1==g.showCloseMessage)if(""!==g.closeMessage){var e={id:g.order.id,message:g.closeMessage,closed:!0,status:"DELIVERY_FAILED"};n.decline(e,function(){o.success("Замовлення закрите")}),u.emit(u.events.decline,g.order),u.hide()}else o.error("Введіть причину відмови від замовлення");g.showCloseMessage=!0,g.closeBtnMessage="відмінити"}function t(){g.showCloseMessage=!1,g.closeBtnMessage="відміна замовлення"}function d(){a.makeCall({line:"901",phone:g.order.client.phoneNumber})}function c(){a.close({id:g.order.id},function(){o.success("Замовлення закрите"),u.emit(u.events.decline,g.order),u.hide()})}var g=this,u=e.get("managerOrderDetailMiniModal");g.closeMessage="",g.showCloseMessage=!!g.closeMessage,g.closeBtnMessage=g.closeMessage?"відмінити":"відміна замовлення",g.showCloseOrderForm=i,g.hideCloseOrderForm=t,g.closeOrder=c,g.makeCall=d,l()}angular.module("app.modals").factory("managerOrderDetailMiniModal",e).controller("managerOrderDetailMiniCtrl",s),e.$inject=["ngDialog","BaseModal"],s.$inject=["BaseModal","helpers","toastr","$scope","orders","operator"]}();
"use strict";!function(){function e(e,r){function s(){e.open({template:"html/modals/manager/order-detail.html",showClose:!1,appendClassName:r.getClassName()+" order-detail",controller:"managerOrderDetailCtrl",controllerAs:"vm"})}function o(){e.close()}var d={update:"update",create:"create",decline:"decline"},i=new r("managerOrderDetailModal",d),n=angular.extend(i,{show:s,hide:o});return n}function r(e,r,s,o,d,i,n,t,a,l){function c(e){var r=i.searchByKey(I.order.dishes,{dishId:e.dishId});r.quantity++}function u(e){var r=i.searchByKey(I.order.dishes,{dishId:e.dishId});r.quantity--,r.quantity||(m()?r.quantity++:I.order.dishes.splice(I.order.dishes.indexOf(r),1))}function h(e){if(!m()){var r=i.searchByKey(I.order.dishes,{dishId:e.dishId});I.order.dishes.splice(I.order.dishes.indexOf(r),1)}}function m(){return!(I.order.dishes.length-1)&&(t.error("Замовлення не можу бути порожнім!"),!0)}function f(){var e=angular.copy(I.order);r.scope.dishes=e.dishes,r.show()}function p(){o.history({clientPhone:I.order.client.phoneNumber},function(e){s.scope={orders:e,hideBack:!0},s.show()})}function v(){if(1==I.showCloseMessage)if(""!==I.closeMessage){var e={id:I.order.id,message:I.closeMessage,closed:!0,status:"DECLINED"};l.decline(e,function(){t.success("Замовлення відмінено")}),N.emit(N.events.decline,I.order),N.hide()}else t.error("Введіть причину відмови від замовлення");I.showCloseMessage=!0,I.closeBtnMessage="відмінити"}function g(){I.showCloseMessage=!1,I.closeBtnMessage="відміна замовлення"}function M(){I.order.dishes.length?I.createEnabled?D():C():t.error("Замовлення не можу бути порожнім!")}function y(){d.close({id:I.order.id},function(){t.success("Замовлення закрите"),N.emit(N.events.decline,I.order),N.hide()})}function D(){I.order.status="KITCHEN";var e=null;if(I.order.timeToDeliver){var r=i.getDate(),s=i.convertHHmm(I.order.timeToDeliver);e=r.str+" "+s+":00"}var o={id:I.order.id,client:{name:I.order.client.name,phone:I.order.client.phoneNumber,address:I.order.client.address},dishes:I.order.dishes,timeToDeliver:e,status:I.order.status};N.hide(),l.create(o,function(e){N.emit(N.events.create,e),t.success("Замовлення оформлено")})}function C(){I.order.status="KITCHEN";var e=null;if(I.order.timeToDeliver){var r=i.getDate(),s=i.convertHHmm(I.order.timeToDeliver);e=r.str+" "+s+":00"}var o={id:I.order.id,client:{name:I.order.client.name,phone:I.order.client.phoneNumber,address:I.order.client.address},dishes:I.order.dishes,timeToDeliver:e,status:I.order.status};N.emit(N.events.update,I.order),N.hide(),l.update(o,function(){t.success("Замовлення оформлено")})}function O(e){var r=!1,s=n.run(e.client,b),o=n.run(e,q);return s.errors.length||o.errors.length||(r=!0),r}function w(e){return e.map(function(e){return{dish:e.dish,id:e.id,dishId:e.dish.id,quantity:e.quantity}})}function H(){d.makeCall({line:"901",phone:I.order.client.phoneNumber})}var I=this,N=e.get("managerOrderDetailModal"),b=[{field:"name",rules:["required"]},{field:"address",rules:["required"]},{field:"phoneNumber",rules:["required","phone"]}],q=[{field:"dishes",rules:["required"]}];if(I.createEnabled=N.scope.createEnabled,I.createEnabled){var B={client:{address:"",name:"",phoneNumber:""},dishes:[],status:"FRESH"};I.order=B}else I.spinner=!0,I.order=N.scope.order,l.getDishes({id:I.order.id},function(e){I.order.dishes=w(e),setTimeout(function(){a.$apply(function(){I.spinner=!1})},500)});I.closeMessage="",I.showCloseMessage=!!I.closeMessage,I.closeBtnMessage=I.closeMessage?"відмінити":"відміна замовлення",I.orderValid=!0,I.selectDishesModal=f,I.historyOrdersModal=p,I.incQuantity=c,I.decQuantity=u,I.removeDish=h,I.showCloseOrderForm=v,I.hideCloseOrderForm=g,I.saveOrder=M,I.convertHHmm=i.convertHHmm,I.makeCall=H,I.closeOrder=y,a.$watch(function(){return I.order.dishes},function(e){e&&(I.orderInfo=i.calculateOrderInfo(I.order))},!0),a.$watch(function(){return I.order},function(e){O(e)?I.orderValid=!0:I.orderValid=!1},!0),r.on(r.events.selected,function(e){I.order.dishes=e})}angular.module("app.modals").factory("managerOrderDetailModal",e).controller("managerOrderDetailCtrl",r),e.$inject=["ngDialog","BaseModal"],r.$inject=["BaseModal","dishesSelectModal","orderHistoryModal","admin","operator","helpers","validator","toastr","$scope","orders"]}();
"use strict";!function(){function e(e,o,n,t,r,i,s){function a(){return e.fetchAvailable({}).$promise.then(function(e){m.callCenter=c(e,p.callCenter).sort(i.compareById),m.kitchen=c(e,p.kitchen).sort(i.compareById),m.delivery=c(e,p.delivery).sort(i.compareById),m.ordersLoading=!1})}function c(e,o){var n=[];return e.forEach(function(e){i.findString(o,e.status)&&n.push(e)}),n}function l(e){h=e,h.timeToDeliver&&(h.timeToDeliver=i.parseDate(h.timeToDeliver)),s.open({template:"html/modals/order-detail-admin.html",className:"ngdialog-theme-default order-detail",controller:u})}function d(e){var o={price:0,count:0},n=!0,t=!1,r=void 0;try{for(var i,s=e.dishes[Symbol.iterator]();!(n=(i=s.next()).done);n=!0){var a=i.value;o.price+=a.dish.price*a.quantity,o.count+=a.quantity}}catch(c){t=!0,r=c}finally{try{!n&&s["return"]&&s["return"]()}finally{if(t)throw r}}return o}function u(e,o,n,t,r){function i(o){t.getDishes({id:o.id},function(n){o.dishes=n,e.order=o,e.orderInfo=d(o),setTimeout(function(){e.$apply(function(){e.spinner=!1})},500)})}function a(){g=s.open({template:"html/modals/order-delivery-admin.html",width:"350px",showClose:!1,controller:f})}function c(){h.status="COOKING",r.makeInCooking({id:h.id},function(){n.success("Замовлення відправлено на кухню")}),s.close()}e.spinner=!0,e.closeMessage="",e.showCloseMessage=!!e.closeMessage,e.closeBtnMessage=e.closeMessage?"відмінити":"відміна замовлення",e.showModalDelivery=a,e.makeInCooking=c,e.convertHHmm=o.convertHHmm,i(h),e.showCloseOrderForm=function(){if(1==e.showCloseMessage)if(""!==e.closeMessage){var r={id:e.order.id,status:"CANT_PREPARE",message:e.closeMessage};t.decline(r,function(){n.success("Замовлення відмінено")});var i=o.searchByKey(m.kitchen,{id:h.id});m.kitchen.splice(m.kitchen.indexOf(i),1),m.kitchen.sort(o.compareById),s.close()}else n.error("Введіть причину відмови від замовлення");e.showCloseMessage=!0,e.closeBtnMessage="відмінити"},e.hideCloseOrderForm=function(){e.showCloseMessage=!1,e.closeBtnMessage="відміна замовлення"}}function f(o,n,t){function r(){n.fetchAll({},function(e){o.courierList=c(e),o.pageLoading=!1})}function s(){g.close()}function a(o){if("BUSY"===o.status)t.warning("Кур’єр зайнятий");else if(h.timeToDeliver){var n=i.getDate(),r=i.convertHHmm(h.timeToDeliver),a=n.str+" "+r+":00";e.update({id:h.id,courierId:o.id,pending:!0,timeToDeliver:a}),h.courier=o,s()}else t.warning("Необхідно спочатку вказати час доставки.")}function c(e){var o=e.filter(function(e){if("OUT"!==e.status)return!0});return o.map(function(e){var o="FREE"===e.status,n=o?"вільний":"зайнятий";return{account:e.account,id:e.id,messagingToken:e.messagingToken,status:e.status,statusText:n,free:o,showForm:!1}})}o.selectedOrder=h,o.closeModal=s,o.sendCourier=a,o.courierList=[],o.pageLoading=!0,r()}var m=this;m.callCenter=[],m.kitchen=[],m.delivery=[],m.ordersLoading=!0,m.showModalOrder=l;var h=void 0,g=void 0,p={callCenter:["FRESH","IN_PROGRESS"],kitchen:["KITCHEN","COOKING","PREPARED"],delivery:["DELIVERY","DONE"]};a(),n.$on(o.refreshPage,function(){t.all([a()]).then(function(){n.$emit(o.refreshPageDone)})}),u.$inject=["$scope","helpers","toastr","orders","admin"],f.$inject=["$scope","courier","toastr"]}angular.module("app.admin.dashboard").controller("DashboardAdmin",e),e.$inject=["orders","APP_EVENTS","$scope","$q","admin","helpers","ngDialog"]}();
...
"use strict";!function(){function e(e,r,n,o,t,i,c,d){function s(){return r.fetchAll({}).$promise.then(function(e){return e}).then(function(e){var r=d.defer(),o=0;return e.forEach(function(t){n.getDishes({id:t.id},function(n){o++,t.dishes=n,o===e.length&&r.resolve(e)})}),r.promise}).then(function(e){m.cooking=o.filterOrdersByStatus(e,P.cooking).sort(o.compareById),m.prepared=o.filterOrdersByStatus(e,P.prepared).sort(o.compareById),k(m.cooking),k(m.prepared),m.ordersLoad=!0})}function a(e){var n=h(e);n.toggle=!1,u(e),r.prepared({id:e.id},function(){t.success("Статус замовлення змінено")})}function p(e){var n=h(e);n.toggle=!1,f(e),r.notPrepared({id:e.id},function(){t.success("Статус замовлення змінено")})}function u(e){m.cooking.splice(m.cooking.indexOf(e),1),m.prepared.push(e),m.prepared.sort(o.compareById)}function f(e){m.prepared.splice(m.prepared.indexOf(e),1),m.cooking.push(e),m.cooking.sort(o.compareById)}function g(e){var r=h(e);r&&(r.toggle=!r.toggle)}function l(){e(function(){m.spinner=!1},400)}function h(e){return o.searchByKey(O,{id:e.id})}function k(e){e.forEach(function(e){h(e)||O.push({id:e.id,toggle:!1})})}var m=this;m.spinner=!0,m.orders=[],m.makePrepared=a,m.makeNotPrepared=p,m.toggleDetailOrder=g,m.findToggleOrder=h,m.ordersLoad=!1;var O=[],P={cooking:["COOKING"],prepared:["PREPARED"]};d.all([s()]).then(function(){l()}),c.$on(i.refreshPage,function(){d.all([s()]).then(function(){c.$emit(i.refreshPageDone)})})}angular.module("app.kitchen.orders").controller("Orders",e),e.$inject=["$timeout","kitchen","orders","helpers","toastr","APP_EVENTS","$scope","$q"]}();
