...
"use strict";!function(){function n(n,e){function t(){n.open({template:"html/modals/admin/ingredients.html",width:"700px",showClose:!1,controller:"ingredientsModalCtrl",controllerAs:"vm"})}function i(){n.close()}var d=new e("ingredientsModal"),o=angular.extend(d,{show:t,hide:i});return o}function e(n,e,t,i,d){function o(){s()}function r(){s()}function a(){s()}function l(){var n=t('<ingredient-add on-add="vm.onAddIngredient()"></ingredient-add>')(d),e=document.getElementsByClassName("add-li-area"),i=angular.element(e);i.after(n)}function s(){c.spinner=!0,e.fetchAll({},function(n){c.ingredients=n,i(function(){c.spinner=!1},400)})}var c=this;n.get("ingredientsModal");c.ingredients=[],c.spinner=!0,c.newIngredient=l,c.onAddIngredient=r,c.onEditIngredient=a,o()}angular.module("app.modals").factory("ingredientsModal",n).controller("ingredientsModalCtrl",e),n.$inject=["ngDialog","BaseModal"],e.$inject=["BaseModal","ingredients","$compile","$timeout","$scope"]}();
