...
"use strict";!function(){function e(e,a,i){return{restrict:"E",replace:!0,scope:{},require:"ngModel",templateUrl:"html/blocks/image-upload/image-upload.html",link:function(r,t,n,s){function l(e){for(var a=i.defer(),r=0,t=[],n=0;n<e.length;n++){var s=new FileReader;s.onload=function(i){r++,t.push(btoa(i.target.result)),r===e.length&&a.resolve(t)},s.readAsBinaryString(e[n])}return a.promise}function u(e){return a.apiUrl+e}function o(e){r.images.splice(r.images.indexOf(e),1),r.images.length||(r.uploaded=!1,s.$setValidity("arrayRequired",!1)),s.$setViewValue(r.images)}function g(e){r.previewImages.splice(r.previewImages.indexOf(e),1),r.previewImages.length||(r.uploaded=!1,s.$setValidity("arrayRequired",!1))}function d(e){for(var a={status:!0,reason:null},i=0;i<e.length;i++)e[i].size>f.max_filesize&&(a.status=!1,a.reason="max_filesize"),f.types.indexOf(e[i].type)===-1&&(a.status=!1,a.reason="format");return a}function m(a){var i="";switch(a.reason){case"max_filesize":i="Максимальний розмір файла 2Мб";break;case"format":i="Заборонений тип файлу"}e.error(i)}r.uploaded=!1,r.previewImages=[],r.images=[],r.removeImage=o,r.removePreview=g,r.fullPath=u,r.$watch(function(){return s.$modelValue},function(e){e.length&&(r.uploaded=!0,r.images=s.$viewValue),s.$render()});var c=t.find("input"),f={max_filesize:2097152,types:["image/png","image/jpg","image/jpeg"]};c.on("change",function(e){var a=[];angular.forEach(e.target.files,function(e){a.push(e)});var t=d(a);t.status?i.all([l(a)]).then(function(e){r.previewImages=e[0],r.uploaded=!0,s.$setViewValue(a),s.$setValidity("arrayRequired",!0)}):m(t)})}}}angular.module("blocks.image-upload",[]).directive("imageUpload",e),e.$inject=["toastr","ENV","$q"]}();
