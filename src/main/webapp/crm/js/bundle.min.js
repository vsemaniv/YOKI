...
"use strict";!function(){function e(e,s){function o(){e.open({template:"html/modals/manager/order-detail-mini.html",showClose:!1,appendClassName:s.getClassName()+" order-detail",controller:"managerOrderDetailMiniCtrl",controllerAs:"vm"})}function r(){e.close()}var n={decline:"decline"},a=new s("managerOrderDetailMiniModal",n),i=angular.extend(a,{show:o,hide:r});return i}function s(e,s,o,r,n,a){function i(){c.spinner=!0,c.order=g.scope.order,n.getDishes({id:c.order.id},function(e){c.order.dishes=e,c.orderInfo=s.calculateOrderInfo(c.order),setTimeout(function(){r.$apply(function(){c.spinner=!1})},500)})}function l(){if(1==c.showCloseMessage)if(""!==c.closeMessage){var e={id:c.order.id,message:c.closeMessage,closed:!0,status:"DELIVERY_FAILED"};n.decline(e,function(){o.success("Замовлення закрите")}),g.emit(g.events.decline,c.order),g.hide()}else o.error("Введіть причину відмови від замовлення");c.showCloseMessage=!0,c.closeBtnMessage="відмінити"}function t(){c.showCloseMessage=!1,c.closeBtnMessage="відміна замовлення"}function d(){a.close({id:c.order.id},function(){o.success("Замовлення закрите"),g.emit(g.events.decline,c.order),g.hide()})}var c=this,g=e.get("managerOrderDetailMiniModal");c.closeMessage="",c.showCloseMessage=!!c.closeMessage,c.closeBtnMessage=c.closeMessage?"відмінити":"відміна замовлення",c.showCloseOrderForm=l,c.hideCloseOrderForm=t,c.closeOrder=d,i()}angular.module("app.modals").factory("managerOrderDetailMiniModal",e).controller("managerOrderDetailMiniCtrl",s),e.$inject=["ngDialog","BaseModal"],s.$inject=["BaseModal","helpers","toastr","$scope","orders","operator"]}();
